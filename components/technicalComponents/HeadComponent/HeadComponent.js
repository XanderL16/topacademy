	...
	render() {
		...
		return <>
			<Head>
				...
				<link rel="alternate icon" href="/images/logo/image.png" />
				<link rel="apple-touch-icon" href="/images/logo/image.png" />
			...
			<Script id="tawktoscriptwrapper" dangerouslySetInnerHTML={{
				__html: `var Tawk_API=Tawk_API||{ }, Tawk_LoadStart=new Date();
					...
					s1.async=true;
					s1.src='https://embed.tawk.to/693007e0bde67719832741bb/1jbhpthr0';
					s1.charset='UTF-8';
					s1.setAttribute('crossOrigin','*');
					s0.parentNode.insertBefore(s1,s0);})();`,
			}}>
			</Script>
			<Script src="https://t.contentsquare.net/uxa/7f91697293983.js"></Script>
